...
public class CrawlDbUpdateUtil <T extends Reducer<Text, CrawlDatum, Text, CrawlDatum>> {
  ...
  protected CrawlDbUpdateUtil(CrawlDbReducer red, Configuration conf) throws IOException {
    reducer = red;
  ...
  public List<CrawlDatum> update(List<CrawlDatum> values) {
    ...
    try {
      reducer.reduce(dummyURL, (Iterator<CrawlDatum>)values, (Reducer<Text, CrawlDatum, Text, CrawlDatum>.Context) context);
    } catch (IOException e) {
