...
public class IndexerMapReduce extends Configured {
  ...
  public void configure(Job job) {
    ...
    this.deleteRobotsNoIndex = conf.getBoolean(INDEXER_DELETE_ROBOTS_NOINDEX,
        false);
    this.deleteSkippedByIndexingFilter = conf.getBoolean(INDEXER_DELETE_SKIPPED,
        false);
    this.skip = conf.getBoolean(INDEXER_SKIP_NOTMODIFIED, false);
    this.base64 = conf.getBoolean(INDEXER_BINARY_AS_BASE64, false);
